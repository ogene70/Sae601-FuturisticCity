...
function Home(){
    ...
    return(
        <Fragment>     
           <Nav deconnexion={logout}></Nav>
            <div className="d-flex container-fluid row bg-primary p-0 mb-5 card bg-dark text-white align-items-center" id="hero">
              <img className="p-0 m-0 card-img"src="https://img.freepik.com/photos-gratuite/scene-projet-environnement-3d_23-2148896006.jpg" alt="heroimage" style={{maxHeight:"60vh",aspectRatio:3/2,objectFit:"cover"}} />
            ...
            <h1>Vous etes connecté {userData?.user_id??"USER"}</h1>
